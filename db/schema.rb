...
ActiveRecord::Schema.define(version: 20140916005223) do
  ...
  add_index "candidates_jobs", ["candidate_id", "job_id"], name: "index_candidates_jobs_on_candidate_id_and_job_id", unique: true, using: :btree
